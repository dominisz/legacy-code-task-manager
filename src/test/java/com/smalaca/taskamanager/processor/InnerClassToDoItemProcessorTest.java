...
class InnerClassToDoItemProcessorTest {
    ...
    //obiekt klasy wewnętrznej na potrzeby testowania
    private final ToDoItemProcessor.ForTesting forTesting = processor.new ForTesting();
    ...
    void shouldProcessDefinedNotAssignedStoryWithTasks() {
        ...
        //when
        forTesting.processDefined(story);
